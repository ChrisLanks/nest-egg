...
@router.get("/year-over-year", response_model=List[Dict[str, Any]])
...
@router.get("/quarterly-summary", response_model=List[Dict[str, Any]])
...
@router.get("/category-trends", response_model=List[Dict[str, Any]])
