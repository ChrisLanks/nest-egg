...
def _compute_scenario_hash(scenario: RetirementScenario) -> str:
    ...
    parts = [
        ...
        str(scenario.current_annual_income),      # used for estimated PIA when use_estimated_pia=True
        str(scenario.spouse_social_security_monthly),
        str(scenario.spouse_social_security_start_age),
        str(scenario.withdrawal_strategy),
        str(scenario.withdrawal_rate),
        str(scenario.federal_tax_rate),
        str(scenario.state_tax_rate),
        str(scenario.capital_gains_rate),
