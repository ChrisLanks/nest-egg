...
from sqlalchemy import Column, String, Boolean, DateTime, Date, ForeignKey, Numeric, Enum as SQLEnum, Index, Integer
...
class RecurringTransaction(Base):
    ...
    amount_variance = Column(Numeric(15, 2), default=Decimal("5.00"), nullable=False)  # Allow +/- $5 by default
