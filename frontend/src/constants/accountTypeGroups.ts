...
> = {
  ...
  [AccountType.CASH]: { label: "Cash", order: 1 },
  ...
  [AccountType.RETIREMENT_529]: { label: "Education", order: 11 },
  ...
  [AccountType.ESPP]: { label: "Equity Compensation", order: 7 },
  [AccountType.TRUST]: { label: "Children's Savings", order: 12 },
  [AccountType.CUSTODIAL_UGMA]: { label: "Education", order: 11 },
  [AccountType.TRUMP_ACCOUNT]: { label: "Education", order: 11 },
