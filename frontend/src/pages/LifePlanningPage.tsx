 ...
 *
 * Combines Social Security Optimizer, Variable Income Planner, and
 * Estate & Beneficiary Planning into a single tabbed view.
 */
    ...
    <Box pt={4}>
      <Box px={6} mb={2}>
        ...
        <Text color="text.secondary" mt={1} fontSize="sm">
          Social Security strategy, variable income smoothing, and estate planning.
        </Text>
      </Box>
