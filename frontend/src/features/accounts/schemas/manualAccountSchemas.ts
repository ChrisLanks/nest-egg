...
export type BasicManualAccountFormData = z.infer<
  typeof basicManualAccountSchema
>;
...
export const investmentAccountSchema = z
  .object({
    ...
    account_type: z.enum([
      ...
      ACCOUNT_TYPES.RETIREMENT_403B,
      ACCOUNT_TYPES.RETIREMENT_457B,
      ACCOUNT_TYPES.RETIREMENT_IRA,
      ACCOUNT_TYPES.RETIREMENT_ROTH,
      ACCOUNT_TYPES.RETIREMENT_SEP_IRA,
      ACCOUNT_TYPES.RETIREMENT_SIMPLE_IRA,
      ACCOUNT_TYPES.TRUMP_ACCOUNT,
...
export const propertyAccountSchema = z.object({
  ...
  property_classification: z
    .enum(["personal_residence", "investment", "vacation_home"])
    .default("personal_residence"),
  property_type: z
...
export const privateEquityAccountSchema = z.object({
  ...
  grant_type: z
    .enum(["iso", "nso", "rsu", "rsa", "profit_interest"])
    .optional(),
...
export type PrivateEquityAccountFormData = z.infer<
  typeof privateEquityAccountSchema
>;
...
export type PrivateDebtAccountFormData = z.infer<
  typeof privateDebtAccountSchema
>;
